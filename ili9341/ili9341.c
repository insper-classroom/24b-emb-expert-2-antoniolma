...
uint16_t ili9341_pinCS  = 9; // GPIO9
uint16_t ili9341_pinDC  = 15; // GPIO15
int16_t  ili9341_pinRST = 14; // GPIO14

uint16_t ili9341_pinSCK = 10; // GPIO10 (SPI1 SCK)
uint16_t ili9341_pinTX  = 11; // GPIO11 (SPI1 MOSI)
...
void initSPI()
{
    // Initialize SPI1 at 40 MHz
    spi_init(ili9341_spi, 40000 * 1000);
    spi_set_format(ili9341_spi, 16, SPI_CPOL_1, SPI_CPHA_1, SPI_MSB_FIRST);

    // Set the GPIO functions for SPI1 pins
